...
class CityTarget(Base):
    ...
    target_value: Mapped[Decimal] = mapped_column("targetValue", Numeric, nullable=False)
    baseline_year: Mapped[date | None] = mapped_column("baselineYear", Date, nullable=True)
